...
public class DossierMedicalControllerImpl implements DossierMedicalController {
    ...
    public void afficherStatistiquesPatient(Long idPatient) throws ServiceException {
        try {
            int nombreRDV = dossierMedicalService.compterRDVPatient(idPatient);
            ...
            DossierMedicalView.afficherStatistiques(nombreRDV, nombreConsultations, risquesCritiques);
        } catch (ServiceException e) {
    ...
    private DossierMedicalDTO convertirDossierEnDTO(DossierMedical dossier) {
        ...
        List<RDVDTO> rdvsDTO = convertirListeRDVsEnDTO(dossier.getRdvs());
        ...
        return DossierMedicalDTO.builder()
                ...
                .nombreRDV(dossier.getRdvs() != null ? dossier.getRdvs().size() : 0)
    ...
    private RDVDTO convertirRDVEnDTO(RDV rdv) {
        ...
        return RDVDTO.builder()
                ...
                .heureFormatee(rdv.getHeure() != null ? rdv.getHeure().toString() : "Non définie")
                .statutAffichage(rdv.getStatut() != null ? rdv.getStatut().name() : "INCONNU")
                .build();
    }
